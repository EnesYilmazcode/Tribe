...
USER_SYNONYMS: dict[str, list[str]] = {
    "environment":  ["whale", "lizard", "animal", "wildlife", "species", "habitat", "ocean",
                     "marine", "fish", "bird", "forest", "tree", "river", "lake", "watershed",
                     "ice", "snow", "glacier", "arctic", "polar", "carbon", "emission",
                     "global warming", "endangered", "national park", "land", "reef"],
    ...
    "criminal_justice": ["police", "jail", "sentencing", "bail", "death penalty",
                         "wrongful conviction", "reentry"],
    "civil_rights": ["race", "racial", "gender", "ballot", "trans", "gay", "marriage equality",
                     "voter", "human rights", "freedom"],
    "labor":        ["job", "minimum wage", "strike", "collective bargaining", "gig worker",
                     "pension", "overtime"],
    "veterans":     ["troop", "vet ", "gi bill", "ptsd", "service member", "wounded warrior"],
    "gun_control":  ["shooting", "ammunition", "mass shooting", "background check", "assault weapon"],
    "reproductive_rights": ["roe", "contraception", "birth control", "ivf", "maternal"],
    "agriculture":  ["ranch", "harvest", "dairy", "organic", "soil", "fishery"],
    "small_business": ["sme", "main street", "mom and pop", "franchise"],
    "technology":   ["ai", "software", "data", "privacy", "robot", "semiconductor", "crypto policy"],
    "finance":      ["bank", "crypto", "stock", "wall st", "fintech", "mortgage rate"],
    "energy":       ["drilling", "grid", "power plant", "renewable energy", "fracking", "ev"],
    "foreign_policy": ["gaza", "china", "russia", "war", "treaty", "sanction", "diplomacy", "aid"],
    "social_welfare": ["hunger", "poverty", "homeless", "food", "soup kitchen", "low income",
                       "disaster relief", "orphan"],
    "infrastructure": ["road", "bridge", "transit", "train", "rail", "internet access", "broadband"],
    "arts_culture": ["museum", "theater", "orchestra", "artist", "gallery", "humanities", "dance"],
}
