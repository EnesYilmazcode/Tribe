...
- **Is the demo live or recorded?** **Recorded.** You submit a **3-minute demo video** + public GitHub repo + Devpost details by the deadline. The video IS the submission.
- **When is the submission deadline?** **4:30 PM ET.** Late submissions may be cut off — treat 4:15 PM as the real wall.
...
- **Coding window:** 11:00 AM → 4:30 PM ET = **5.5 hours total**, but ~45 min of that is demo recording + submission. Real build time ≈ **4h 45m**.
...
| **MVP spine** | 11:30 – 12:45 | Phase 1 — ClickHouse | `agent.py` returns ranked real donors from real FEC data ← **MVP** |
