...
- **Format:** Single-day. Coding 11:00 AM to 4:30 PM ET. Finalists/judging 5:00 PM, awards 7:00 PM.
- **Demo:** 3 minutes, live.
- **Team size:** Max 4.
...
- **Senso.ai:** $3,000 credits (1 winner). Use Senso content-gen APIs to publish grounded, **citeable** content to `cited.md` (or another public destination). **Ingestion alone won't qualify**, you must close the loop from knowledge base to published, agent-discoverable content. Docs: docs.senso.ai

## What to submit
1. **Demo video LINK:** the 3-min video must be uploaded to YouTube/Vimeo (unlisted is fine) and the **public URL pasted into Devpost.** A local file does NOT count. Upload right after recording and leave buffer for the upload to finish processing.
2. Public GitHub repo
3. All Devpost-required project details

## Our project — Tribe (donor-prospecting agent)
**One-liner:** Fundraiser types a natural-language ask, the agent finds the best real donors and publishes cited prospect profiles, autonomously.

**Pipeline and tool mapping (3 sponsors, all with prize tracks):**
...
3. **Senso:** publish a cited prospect profile per match to cited.md (closes the KB-to-published loop)

*x402 (payment rail) is out of scope. It's not a prize-track sponsor and is too much setup risk. The 3 above already meet the "3+ tools" judging mark.*
...
- [ ] Wire Senso to cited.md publishing
- [ ] Record 3-min demo
